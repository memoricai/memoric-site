...
export default function CorporateTraining() {
  ...
  const ctDescription = settings?.ct_description ?? "";
  const trainingModules = (settings?.modules ?? []).map((m, idx) => ({
    id: idx + 1,
    title: m.module,
    level: m.level,
    ...
    <div className="w-full bg-gradient-to-r from-slate-50 via-white to-slate-50 py-12 md:py-16 lg:py-20">
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="text-center mb-8 md:mb-10 lg:mb-12">
          ...
          <p className="text-sm sm:text-base text-slate-700 max-w-4xl mx-auto px-2 leading-relaxed">
          ...
          {trainingModules.map((module) => (
            ...
            >
              <div className="mb-3 md:mb-4">
                ...
                <p className="text-xs md:text-sm text-slate-600 italic">{module.level}</p>
              </div>
